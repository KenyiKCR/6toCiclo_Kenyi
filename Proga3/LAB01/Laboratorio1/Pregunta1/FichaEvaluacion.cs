...
namespace Pregunta1{
	public class FichaEvaluacion{
		...
		public Estado Estado_candidato {
			get{
				int? puntaje_total = this.Evaluacion_expediente + this.Evaluacion_entrevista +
				this.Evaluacion_examen;
				if(puntaje_total>75) this.estado_candidato=Estado.ADMITIDO;
		...
		public FichaEvaluacion(Postulante candidato, DateTime fecha_hora, int evaluacion_entrevista,
			int evaluacion_examen, int evaluacion_expediente, Estado estado_candidato){
